...
\begin{enumerate}
\item Get the coordinate of the sounds into a 2D space using 2 of the features implemented
\item Use the \textbf{napping} function to display this projection.
\item Compare qualitatively the organization of the sounds in the "acoustical" plane and in the "human" one. Perform  a quantitative analysis using the \textbf{daniels} function. 
\end{enumerate}
